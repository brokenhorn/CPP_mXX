...
ShrubberyCreationForm::ShrubberyCreationForm(std::string target): Form("ShrubberyCreationForm", 145, 137),_target(target), _f_name("shrubbery request")
{
...
std::string ShrubberyCreationForm::getF()
{
	return this->_f_name;
}

Form *ShrubberyCreationForm::cmp_f(std::string target)
{
